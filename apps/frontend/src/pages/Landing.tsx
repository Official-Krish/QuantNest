...
import { OpenClawSection } from "@/components/LandingPage/OpenClawSection";

export const Landing = () => {
  const [comingSoonTarget, setComingSoonTarget] = useState<"pricing" | null>(
    null,
  );
  ...
  return (
    <div className="bg-black min-h-screen w-full">
      ...
      <ComingSoonModal
        ...
        title={"Pricing plans are being finalized"}
        description={
