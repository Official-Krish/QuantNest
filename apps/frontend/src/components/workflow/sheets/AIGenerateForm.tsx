...
import { Bot, ShieldCheck, Brain, Database, Globe } from "lucide-react";
import { AIGenerateMetadataSchema } from "@quantnest-trading/types";
...
export const AIGenerateForm = ({
  ...
  const validationErrors = useMemo(() => {
    const result = AIGenerateMetadataSchema.safeParse(metadata);
    if (!result.success) {
    ...
    <div className="space-y-4 rounded-2xl border border-neutral-800 bg-neutral-950/70 p-3">
      <div className="space-y-2">
        ...
        <textarea
          ...
          rows={3}
          placeholder="Analyze the market conditions and provide a summary of the key insights."
        />
        ...
        {(metadata.approvalRequired as boolean) && (
          <div className="space-y-2 pl-6">
            ...
            <textarea
              ...
              rows={2}
              placeholder="e.g. Review the generated analysis before dispatching."
            />
          </div>
        )}
