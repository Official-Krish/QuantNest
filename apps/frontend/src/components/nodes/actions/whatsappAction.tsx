...
export const whatsappAction = ({
  ...
  const { recipientPhone, recipientName } = data.metadata || {};

  return (
    <div className="min-w-57.5 rounded-2xl border border-neutral-700/80 bg-neutral-950/90 px-4 py-3 shadow-[0_0_0_1px_rgba(255,255,255,0.04)]">
      <div className="flex items-center justify-between gap-2">
        <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#25D366]">
          WhatsApp
        </span>
