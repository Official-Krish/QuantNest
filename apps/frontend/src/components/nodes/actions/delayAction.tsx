...
export const delayAction = ({
  ...
  return (
    <div className="min-w-[220px] rounded-2xl border border-neutral-700/80 border-l-[5px] border-l-[#fbbf24] bg-neutral-950/90 px-4 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_0_0_1px_rgba(255,255,255,0.04)]">
