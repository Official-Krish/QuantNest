    ...
    onFinalFailure: async (error) => {
      ...
      if (context.userId) {
        await createUserNotification({
          ...
          message: error instanceof Error ? error.message : "The Notion reporting action failed.",
    ...
    onFinalFailure: async (error) => {
      ...
      if (context.userId) {
        await createUserNotification({
          ...
          message: error instanceof Error ? error.message : "The daily CSV export could not be uploaded to Google Drive.",
          metadata: { nodeId: node.nodeId },
    ...
    onFinalFailure: async (error) => {
      ...
      if (context.userId) {
        await createUserNotification({
          ...
          message: error instanceof Error ? error.message : "Failed to append workflow report row to Google Sheets.",
          metadata: { nodeId: node.nodeId },
